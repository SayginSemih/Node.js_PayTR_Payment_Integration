...
var merchant_key = 'XXXXX';
var merchant_salt = 'XXXXX';
...
var email = 'dsfgadsgasdg@hotmail.com'; // Müşterinizin sitenizde kayıtlı veya form vasıtasıyla aldığınız eposta adresi.
...
var user_name = 'SEMİH SAYGIN'; // Müşterinizin sitenizde kayıtlı veya form aracılığıyla aldığınız ad ve soyad bilgisi
var user_address = 'Torbalı Mah'; // Müşterinizin sitenizde kayıtlı veya form aracılığıyla aldığınız adres bilgisi
...
var merchant_ok_url = 'http://localhost:5173/odeme_basarili';
// Ödeme sürecinde beklenmedik bir hata oluşması durumunda müşterinizin yönlendirileceği sayfa
// Bu sayfa siparişi iptal edeceğiniz sayfa değildir! Yalnızca müşterinizi bilgilendireceğiniz sayfadır!
var merchant_fail_url = 'http://localhost:5173/odeme_hata';
...
router.get("/paytr", function (req, res) {
...
router.post("/callback", function (req, res) {
    ...
    if (callback.status == 'success') {
        ...
        res.send("1") // BAŞARILI İSE 1 DÖNER
    } else {
        //basarisiz
        console.log("BAŞARISIZ")
        res.send("2") // BAŞARISIZ İSE 2 DÖNER
    }
